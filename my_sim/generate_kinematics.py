...
output_path = Path("./output_16O_invariant/kinematics/o16a4a_700Torr_161.6MeV_15MeV.h5")
...
pipeline = KinematicsPipeline(
    ...
    [ExcitationGaussian(20.0, 0.001),ExcitationGaussian(7.654, 0.001),ExcitationGaussian(0, 0.001),ExcitationGaussian(0.0, 0.001)], # No width to ground state #need to add energues above threhold  make the width super narrow
    # [ExcitationGaussian(20, 3.0)],
